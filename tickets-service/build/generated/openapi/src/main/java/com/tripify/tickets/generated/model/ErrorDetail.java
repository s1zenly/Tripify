...
public class ErrorDetail {
  ...
  @Schema(name = "field", example = "departure_date", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("field")
  ...
  @Schema(name = "message", example = "must not be null", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
