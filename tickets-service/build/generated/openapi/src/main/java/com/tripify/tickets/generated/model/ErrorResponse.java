...
import com.tripify.tickets.generated.model.ErrorDetail;
...
public class ErrorResponse {
   ...
   */
  public ErrorResponse(ErrorCode code, String message, OffsetDateTime timestamp) {
    this.code = code;
   ...
   */
  @NotNull 
  @Schema(name = "message", example = "Invalid date", requiredMode = Schema.RequiredMode.REQUIRED)
