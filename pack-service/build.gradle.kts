...
openApiGenerate {
    ...
    apiPackage.set("com.tripify.pack.generated.api")
    modelPackage.set("com.tripify.pack.generated.model")
    invokerPackage.set("com.tripify.pack.generated.invoker")
    ...
    importMappings.set(
        mapOf(
            "GenerationMode" to "com.tripify.pack.domain.GenerationMode"
        )
    )
}
