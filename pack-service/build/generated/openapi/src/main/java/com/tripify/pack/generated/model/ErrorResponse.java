...
public class ErrorResponse {
   ...
   */
  public ErrorResponse(PackErrorCode code, String message, OffsetDateTime timestamp) {
    this.code = code;
    this.message = message;
    this.timestamp = timestamp;
  }

  public ErrorResponse code(PackErrorCode code) {
    this.code = code;
    return this;
  }
  ...
  @JsonProperty("code")
  public PackErrorCode getCode() {
    return code;
  }

  public void setCode(PackErrorCode code) {
    this.code = code;
  }
   ...
   */
  @NotNull 
  @Schema(name = "message", example = "Pack not found", requiredMode = Schema.RequiredMode.REQUIRED)
