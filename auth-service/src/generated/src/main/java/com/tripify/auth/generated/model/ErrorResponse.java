...
public class ErrorResponse {
   ...
   */
  public ErrorResponse(String code, String message, OffsetDateTime timestamp) {
    this.code = code;
   ...
   */
  @NotNull 
  @Schema(name = "code", example = "INVALID_OTP_CODE", requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty("code")
   ...
   */
  @NotNull 
  @Schema(name = "message", example = "Invalid OTP code", requiredMode = Schema.RequiredMode.REQUIRED)
