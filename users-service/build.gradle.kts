...
openApiGenerate {
    ...
    apiPackage.set("com.tripify.users.generated.api")
    modelPackage.set("com.tripify.users.generated.model")
    invokerPackage.set("com.tripify.users.generated.invoker")
