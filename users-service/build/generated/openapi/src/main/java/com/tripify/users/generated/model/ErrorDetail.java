...
public class ErrorDetail {
  ...
  @Schema(name = "field", example = "phoneNumber", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("field")
  ...
  @Schema(name = "message", example = "must be a valid phone number", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
