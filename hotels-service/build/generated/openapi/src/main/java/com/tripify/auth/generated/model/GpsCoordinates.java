...
public class GpsCoordinates {
  ...
  public GpsCoordinates latitude(@Nullable Double latitude) {
  ...
  @Schema(name = "latitude", example = "40.7089767", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  ...
  public GpsCoordinates longitude(@Nullable Double longitude) {
  ...
  @Schema(name = "longitude", example = "-74.0091231", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
