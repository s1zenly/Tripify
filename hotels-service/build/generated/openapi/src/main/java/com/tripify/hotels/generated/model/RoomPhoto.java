...
public class RoomPhoto {
  ...
  public RoomPhoto url(@Nullable URI url) {
    this.url = url;
    return this;
  }
   ...
   */
  @Valid 
  @Schema(name = "url", example = "https://images.example.com/rooms/photo_0.jpg", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("url")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.url, roomPhoto.url);
  }
