...
comment on column hotels.id is 'Внутренний уникальный идентификатор отеля в hotels-service';
...
comment on column hotels.currency is 'Валюта цены';
comment on column hotels.price is 'Минимальная цена проживания';
comment on column hotels.hotel_class is 'Класс отеля в звездах';
comment on column hotels.reviews_mongo_id is 'Идентификатор документа с отзывами в MongoDB';
